...
def start_service():
    ...
    #get_index
    dispatcher.connect('dict_get_index','/dictionary/', controller=dictionaryController, action='GET_INDEX', conditions=dict(method=['GET']))
    #delete_key
    ...
    #delete_index
    dispatcher.connect('dict_delete_index','/dictionary/', controller=dictionaryController, action='DELETE_INDEX', conditions=dict(method=['DELETE']))
    #post_index
    dispatcher.connect('dict_post_index','/dictionary/', controller=dictionaryController, action='POST_INDEX', conditions=dict(method=['POST']))
    #put_index
